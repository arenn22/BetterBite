...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        <Text style={styles.heading}>Instruments ({instruments.length})</Text>
        {instruments.map((instrument) => (
          <Text key={instrument.id} style={styles.item}>{instrument.name}</Text>
        ))}
        <Text style={styles.heading}>Users ({users.length})</Text>
        {users.map((user) => (
          <Text key={user.user_id} style={styles.item}>{user.username}</Text>
        ))}
